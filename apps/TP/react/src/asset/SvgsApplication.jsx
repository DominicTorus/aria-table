...
import { SiElement, SiSecurityscorecard } from 'react-icons/si';
    ...
    >
      ...
      >
        <path
          ...
          stroke={darkMode ? 'white' : 'black'}
        />
        <mask id="path-10-inside-1_17_84" fill="white">
          <path
  ...
  return (
    ...
    >
      ...
      <mask
        ...
        animate={{ pathLength: 1 }}
      >
        <rect fill="white" x="40.3494" y="124.016" width="10" height="5" />
        <path
      ...
      <mask
        ...
        animate={{ pathLength: 1 }}
      >
        <rect fill="white" x="76.3364" y="124.016" width="10" height="5" />
        <path
...
export const SourceIcon = ({ className }) => {
  ...
  return (
    <ImMoveUp
      ...
      className={
        darkMode
          ? `${className} font-bolder cursor-pointer text-zinc-100`
          : `${className} font-bolder cursor-pointer  text-[#3F3F46]`
      }
    />
  );
};

export const MapperIcon = ({ className }) => {
  const { darkMode } = useContext(DarkmodeContext);
  return (
    <LiaSitemapSolid
      size={20}
...
export const RulesIcon = ({ className }) => {
  const { darkMode } = useContext(DarkmodeContext);
...
export const CustomCode = ({ className }) => {
  const { darkMode } = useContext(DarkmodeContext);
  return (
    <LuFileCode2
      className={
...
export const Validation = ({ className }) => {
  const { darkMode } = useContext(DarkmodeContext);
  return (
    <GrValidate
      className={
...
export const Execution = ({ className }) => {
  const { darkMode } = useContext(DarkmodeContext);
  return (
    <SiSecurityscorecard
      className={
...
export const ElementInfo = ({ className }) => {
  const { darkMode } = useContext(DarkmodeContext);
  return (
    <SiElement
      size={20}
...
export const Enities = ({ className }) => {
  const { darkMode } = useContext(DarkmodeContext);
  return (
    <svg
      className={className}
...
export const Enumeration = ({ className }) => {
  const { darkMode } = useContext(DarkmodeContext);
  return (
    <svg
      className={className}
...
export const ProcessObject = ({ className }) => {
  const { darkMode } = useContext(DarkmodeContext);
  return (
    <svg
      className={className}
...
export const MainpageLoader = () => {
  ...
  useEffect(() => {
    // Animate the SVG paths using GSAP
  ...
  return (
    <div
      className={
        'flex h-[100vh] w-[100%] items-center justify-center' +
...
export const Subloader = ({ color, bgColor }) => {
  const pathsRef = useRef([]);
...
export const SvgAddIcon = (props) => {
  ...
  return (
    <svg
      className={
        darkMode
          ? `transition-ease-in-out flex cursor-pointer items-center justify-center rounded-xl 
                      bg-transparent p-1 duration-300 hover:scale-105 hover:bg-slate-700`
          : `transition-ease-in-out flex cursor-pointer items-center justify-center rounded-xl 
                      bg-transparent p-1 duration-300 hover:scale-105 hover:bg-slate-200`
      }
      height="33"
      viewBox="0 0 24 24"
      fill="none"
